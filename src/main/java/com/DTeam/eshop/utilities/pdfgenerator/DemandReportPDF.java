...
public class DemandReportPDF {

    public static ByteArrayInputStream demandReport(List<Product> productList) throws IOException {
		...
		try {
            ...
            document.open();
            Paragraph header = new Paragraph("Zapotrzebowanie na sprzęt",headFont);
